<template>
  <div>
    <el-dialog title="修改" :visible.sync="dialog_info_flag" @close="close" width="576px" @opened="dialogOpened">
...
import { Add, GetList, EditInfo } from "@/api/news.js";
export default {
  name: "dialogInfo",
  props: {
    flag: {
